...
cd ${BASEDIR}
./make_aar.sh build/aar/ flac 1.4.1 ./build/android/ libFLAC.a FLAC
...
./make_aar.sh build/aar/ oboe 1.7.0 ./build/android/ liboboe.a oboe
...
./make_aar.sh build/aar/ boost 1.81.0 ./build/android/ "" boost_1_81_0/boost
